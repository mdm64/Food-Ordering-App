...
class UserClass extends React.Component {
    ...
    async componentDidMount() {
        const apiData = await fetch("https://api.github.com/users/mdm64");
        ...
        return (
            <div className="max-w-md p-4 sm:flex sm:space-x-6">
                <div class="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0">
                    <img src={avatar_url} alt="" class="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-300" />
                </div>
                <div class="flex flex-col">
                    <div>
                        <h2 class="text-2xl font-semibold">{name}</h2>
                        <span class="text-sm dark:text-gray-600">Software Engineer</span>
                    </div>

                    <div class="flex justify-center pt-4 space-x-4 align-center">
                        <a rel="noopener noreferrer" href="https://github.com/mdm64" aria-label="GitHub" class="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
